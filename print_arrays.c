...
void print_long_double_array(long double *array, int size) {
  print_array(from_long_double, _native_buffer, array, size, sizeof (long double));
}
...
void print_long_long_int_array(long long int *array, int size) {
  print_array(from_long_long_int, _native_buffer, array, size, sizeof (long long int));
}
...
void print_unsigned_int_array(unsigned int *array, int size) {
  print_array(from_unsigned_int, _native_buffer, array, size, sizeof (unsigned int));
}

void print_unsigned_long_int_array(unsigned long int *array, int size) {
  print_array(from_unsigned_long_int, _native_buffer, array, size, sizeof (unsigned long int));
}

void print_unsigned_long_long_int_array(unsigned long long int *array, int size) {
  print_array(from_unsigned_long_long_int, _native_buffer, array, size, sizeof (unsigned long long int));
}

void print_unsigned_short_int_array(unsigned short int *array, int size) {
  print_array(from_unsigned_short_int, _native_buffer, array, size, sizeof (unsigned short int));
}
